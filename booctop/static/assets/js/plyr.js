"object" == typeof navigator && function (e, t) {
    ...
    var A, E, S, P = function () {
        ...
        return i(t, [{
            ...
            key: "get", value: function (e) {
                ...
                var i, n = e.target, a = e.changedTouches[0], s = parseFloat(n.getAttribute("min")) || 0,
                    r = parseFloat(n.getAttribute("max")) || 100, o = parseFloat(n.getAttribute("step")) || 1,
                    l = r - s, c = n.getBoundingClientRect(), u = 100 / c.width * (this.config.thumbWidth / 2) / 100;
    ...
    }, X = j, J = (A = document.createElement("span"), E = {
    ...
    function le(e, t) {
        ...
        return e.split(",").forEach((function (e) {
            var t = e.trim(), a = t.replace(".", ""), s = t.replace(/[[\]]/g, "").split("="), o = r(s, 1)[0],
    ...
    function Me(e) {
        ...
        var t = r(e, 2), i = t[0], n = t[1], a = function e(t, i) {
    ...
    function xe(e) {
        ...
        var t = this.elements.wrapper, i = Ne.call(this, e), n = r(B(i) ? i : [0, 0], 2), a = 100 / n[0] * n[1];
    ...
    var De = {pip: "PIP", airplay: "AirPlay", html5: "HTML5", vimeo: "Vimeo", youtube: "YouTube"}, Fe = function () {
        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "",
            t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
        if (X(e) || X(t)) return "";
        var i = Z(t.i18n, e);
    ...
    var Ye = {
        getIconUrl: function () {
            ...
            var i = Ye.getIconUrl.call(this), n = "".concat(i.cors ? "" : i.url, "#").concat(this.config.iconPrefix),
                a = document.createElementNS("http://www.w3.org/2000/svg", "svg");
            ie(a, ee(t, {role: "presentation", focusable: "false"}));
            var s = document.createElementNS("http://www.w3.org/2000/svg", "use"), r = "".concat(n, "-").concat(e);
            ...
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, i = Fe(e, this.config),
            ...
            })) || ee(n, {class: "".concat(n.class, " ").concat(this.config.classNames.control)}) : n.class = this.config.classNames.control, e) {
                case"play":
            ...
            if ("volume" !== e) {
                ...
                var n = {played: "played", buffer: "buffered"}[e], a = n ? Fe(n, this.config) : "";
                i.innerText = "% ".concat(a.toLowerCase())
            }
            return this.elements.display[e] = i, i
        }, createTime: function (e, t) {
            var i = le(this.config.selectors.display[e], t), n = ne("div", ee(i, {
            ...
            var t = this, i = e.value, n = e.list, a = e.type, s = e.title, r = e.badge, o = void 0 === r ? null : r,
                l = e.checked, c = void 0 !== l && l, u = le(this.config.selectors.inputs[a]), d = ne("button", ee(u, {
                    type: "button",
                    role: "menuitemradio",
            ...
            if (W(t) && "range" === t.getAttribute("type")) {
                if (he(t, this.config.selectors.inputs.seek)) {
                    ...
                    var i = Ye.formatTime(this.currentTime), n = Ye.formatTime(this.duration),
            ...
            var e = this.elements.settings.buttons, t = !X(e) && Object.values(e).some((function (e) {
                return !e.hidden
            }));
            ...
            if (W(t) && W(i)) {
                ...
                if (R(e)) a = e; else if (K(e) && 27 === e.which) a = !1; else if (z(e)) {
                    var s = V(e.composedPath) ? e.composedPath()[0] : e.target, r = t.contains(s);
            ...
            var t = this, i = Ye.bindMenuItemShortcuts, n = Ye.createButton, a = Ye.createProgress, s = Ye.createRange,
                r = Ye.createTime, o = Ye.setQualityMenu, l = Ye.setSpeedMenu, c = Ye.showMenuPanel;
            ...
            return Le(this.config.controls).forEach((function (o) {
                ...
                if ("current-time" === o && u.appendChild(r.call(t, "currentTime", d)), "duration" === o && u.appendChild(r.call(t, "duration", d)), "mute" === o || "volume" === o) {
                    ...
                    if (W(m) && u.contains(m) || (m = ne("div", ee({}, d, {class: "".concat(d.class, " plyr__volume").trim()})), t.elements.volume = m, u.appendChild(m)), "mute" === o && m.appendChild(n.call(t, "mute")), "volume" === o && !G.isIos) {
                ...
                if ("captions" === o && u.appendChild(n.call(t, "captions", d)), "settings" === o && !X(t.config.settings)) {
                    ...
                    var y = ne("div", {class: "plyr__menu__container", id: "plyr-settings-".concat(e.id), hidden: ""}),
                        v = ne("div"), b = ne("div", {id: "plyr-settings-".concat(e.id, "-home")}),
                        w = ne("div", {role: "menu"});
                    b.appendChild(w), v.appendChild(b), t.elements.settings.panels.home = b, t.config.settings.forEach((function (n) {
                        ...
                        l.appendChild(ne("span", {"aria-hidden": !0}, Fe(n, t.config))), l.appendChild(ne("span", {class: t.config.classNames.hidden}, Fe("menuBack", t.config))), ke.call(t, o, "keydown", (function (e) {
    ...
    var Je = {
            setup: function () {
                ...
                var e = this, t = Je.getTracks.call(this, !0), i = this.captions, n = i.active, a = i.language, s = i.meta,
                ...
                if (this.supported.ui) {
                    var i = this.captions.toggled, n = this.config.classNames.captions.active, a = q(e) ? !i : e;
                    if (a !== i) {
                ...
                var t = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1], i = Je.getTracks.call(this);
                if (-1 !== e) if (D(e)) if (e in i) {
                ...
                } else this.debug.warn("Track not found", e); else this.debug.warn("Invalid caption argument", e); else Je.toggle.call(this, !1, t)
                ...
                var t, i = this, n = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                    a = Je.getTracks.call(this), s = function (e) {
                ...
                if (this.supported.ui) if (W(this.elements.captions)) if (q(e) || Array.isArray(e)) {
                    var t = e;
                    if (!t) {
            ...
            events: ["ended", "progress", "stalled", "playing", "waiting", "canplay", "canplaythrough", "loadstart", "loadeddata", "loadedmetadata", "timeupdate", "volumechange", "play", "pause", "error", "seeking", "seeked", "emptied", "ratechange", "cuechange", "download", "enterfullscreen", "exitfullscreen", "captionsdisabled", "languagechange", "controlshidden", "controlsshown", "ready", "statechange", "qualitychange", "adsloaded", "adscontentpause", "adscontentresume", "adstarted", "adsmidpoint", "adscomplete", "adsallcomplete", "adsimpression", "adsclick"],
            selectors: {
        ...
        }, Ge = "picture-in-picture", Ze = "inline", et = {html5: "html5", youtube: "youtube", vimeo: "vimeo"},
        tt = "audio", it = "video";
    var nt = function () {
    }, at = function () {
        function t() {
    ...
    var ot = {
        addStyleHook: function () {
            ...
            if (F(this.config.title) && !X(this.config.title) && (e += ", ".concat(this.config.title)), Array.from(this.elements.buttons.play || []).forEach((function (t) {
                ...
                if (!W(t)) return;
                var i = X(this.config.title) ? "video" : this.config.title, n = Fe("frameTitle", this.config);
        ...
        return i(t, [{
            ...
            key: "container", value: function () {
                ...
                ke.call(e, i.container, "enterfullscreen exitfullscreen", (function (t) {
                    ...
                    if (o === i.container && (e.isEmbed || !X(e.config.ratio))) {
                        ...
                        !function (t, i, n) {
                            if (e.isVimeo) {
                                var a = e.elements.wrapper.firstChild, s = r(t, 2)[1], o = r(Ne.call(e), 2), l = o[0],
                                    c = o[1];
            ...
            key: "controls", value: function () {
                var e = this, t = this.player, i = t.elements, n = G.isIE ? "change" : "input";
                if (i.buttons.play && Array.from(i.buttons.play).forEach((function (i) {
                    ...
                    if (!K(e) || 39 === n || 37 === n) {
                        ...
                        var a = i.hasAttribute("play-on-seeked"), s = ["mouseup", "touchend", "keyup"].includes(e.type);
                ...
                this.bind(i.inputs.seek, n, (function (e) {
                    ...
                    var i = e.webkitDirectionInvertedFromDevice, n = r([e.deltaX, -e.deltaY].map((function (e) {
                        return i ? -e : e
                    })), 2), a = n[0], s = n[1], o = Math.sign(Math.abs(a) > Math.abs(s) ? a : s);
    ...
    var ct = function (e, t) {
        ...
        e.exports = function () {
            ...
            function r(t, i, n, a) {
                var s, o, l = document, c = n.async, u = (n.numRetries || 0) + 1, d = n.before || e,
    ...
    var ht = {
        setup: function () {
            ...
            var e = this, t = this, i = t.config.vimeo, n = Xe(ee({}, {
                loop: t.config.loop.active,
                autoplay: t.autoplay,
                muted: t.muted,
                gesture: "media",
                playsinline: !this.config.fullscreen.iosNative
            }, i)), a = t.media.getAttribute("src");
    ...
    var ft = {
        ...
        return i(t, [{
                                ...
                                e.split(/\r\n|\n|\r/).forEach((function (e) {
                                    if (D(t.startTime)) {
                                        if (!X(e.trim()) && X(t.text)) {
                                            var i = e.trim().split("#xywh="), n = r(i, 1);
                                            if (t.text = n[0], i[1]) {
                                                var a = r(i[1].split(","), 4);
            ...
            key: "render", value: function () {
                this.elements.thumb.container = ne("div", {class: this.player.config.classNames.previewThumbnails.thumbContainer}), this.elements.thumb.imageContainer = ne("div", {class: this.player.config.classNames.previewThumbnails.imageContainer}), this.elements.thumb.container.appendChild(this.elements.thumb.imageContainer);
        ...
        insertElements: function (e, t) {
            var i = this;
            F(t) ? ae(e, this.media, {src: t}) : B(t) && t.forEach((function (t) {
                ae(e, i.media, t)
            }))
        }, change: function (e) {
            var t = this;
            Z(e, "sources.length") ? (Ie.cancelRequests.call(this), this.destroy.call(this, (function () {
                ...
                var i = e.sources, n = e.type, a = r(i, 1)[0], s = a.provider, o = void 0 === s ? et.html5 : s,
                    l = a.src, c = "html5" === o ? n : "div", u = "html5" === o ? {} : {src: l};
                Object.assign(t, {
                    provider: o,
                    type: n,
    ...
    var kt, Tt = function () {
        function t(i, n) {
            ...
            if (e(this, t), this.timers = {}, this.ready = !1, this.loading = !1, this.failed = !1, this.touch = ve.touch, this.media = i, F(this.media) && (this.media = document.querySelectorAll(this.media)), (window.jQuery && this.media instanceof jQuery || U(this.media) || B(this.media)) && (this.media = this.media[0]), this.config = ee({}, $e, t.defaults, n || {}, function () {
                ...
                speed: [],
                quality: []
            }, this.debug = new at(this.config.debug), this.debug.log("Config", this.config), this.debug.log("Support", ve), !q(this.media) && W(this.media)) if (this.media.plyr) this.debug.warn("Target already setup"); else if (this.config.enabled) if (ve.check().api) {
        ...
        return i(t, [{
            ...
            key: "quality", set: function (e) {
                ...
                if (i.length) {
                    var n = [!X(e) && Number(e), this.storage.get("quality"), t.selected, t.default].find(D), a = !0;
                    if (!i.includes(n)) {
                        var s = function (e, t) {
